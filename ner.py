...
ents = []
titles = ['Master ', 'Mr. ', 'Miss ', 'Ms. ', 'Mrs. ', 'Sir ', 'Madam ', 'Dame ', 'Lord ', 'Lady ', 'Doctor ', 'Dr. ', 'Professor ', 'Fr. ', 'Pr. ', 'Br. ', 'Sr. ', 'Father ', 'Pastor ', 'Brother ', "Sister "]
    ...
    for i in range(1,len(tup)):
        ...
        for ent in doc.ents:
            if ent.label_ == "PERSON":
                to_append = ent.text
                for t in titles:
                    if ent.start_char >= len(t) and tup[i][(ent.start_char-len(t)):(ent.start_char)] == t:
